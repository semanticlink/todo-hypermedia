...
namespace Toolkit
{
    public static class ExceptionExtensions
    {
        ...
        [NotNull]
        public static T ThrowArgumentExceptionIf<T>(this T anObject,
        ...
        [NotNull]
        public static T ThrowArgumentNullExceptionIf<T>(this T anObject,
            Func<T, bool> predicate,
            string argumentName,
            string message)
        {
        ...
        [NotNull]
        public static IEnumerable<T> ThrowInvalidDataExceptionIfNullOrEmpty<T>(this IEnumerable<T> anObject,
            string message)
            where T : class
        {
        ...
        public static string ThrowConfigurationErrorsExceptionIfNotNullOrWhiteSpace(this string anObject,
            string message)
        {
        ...
        [NotNull]
        public static T ConfigurationErrorsExceptionIf<T>(this T anObject,
            Func<T, bool> predicate,
            Func<string> message)
        {
            if (predicate(anObject))
